...
// Generic category icon mapping
const getCategoryIcon = (categoryName: string): string => {
  const name = categoryName.toLowerCase();
  
  if (name.includes("furniture")) return "🛋️";
  if (name.includes("bedding") || name.includes("textile")) return "🛏️";
  if (name.includes("electronics") || name.includes("appliances")) return "📱";
  if (name.includes("lighting") || name.includes("electrical")) return "💡";
  ...
  if (name.includes("sports") || name.includes("outdoor")) return "⚽";
  if (name.includes("toys") || name.includes("games")) return "🎮";
  if (name.includes("garden")) return "🌱";
  if (name.includes("automotive")) return "🚗";
  
  return "📦"; // Default miscellaneous icon
};

export default function CategoriesCarousel({ categories }: { categories: CategoryItem[] }) {
